    ...
    internal class Provider
    {
        ...
        public void InteractWithStore()
        {
            ...
            while (choice != 0)
            {
                ...
                {
                    case 0:
                        Console.WriteLine("Thank you and take care of your health");
                        break;
                    case 1:
        ...
        private void BookAppointment()
        {
            ...
            Console.WriteLine($"Slot 1 : 9.00 - 11.00am \tSlot 2 : 2.00 - 4.pm \tSlot 3 : 8.30 - 10.30pm ");
            ...
            bool result = false;
            if(ManageAppointment.CheckAvailability(id , slot)) 
            {
