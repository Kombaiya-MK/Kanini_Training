...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAppPubs.Models.Author", b =>
                {
            ...
            modelBuilder.Entity("WebAppPubs.Models.Discount", b =>
                {
            ...
            modelBuilder.Entity("WebAppPubs.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("WebAppPubs.Models.Job", b =>
                {
                    b.Property<short>("JobId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("WebAppPubs.Models.PubInfo", b =>
                {
                    b.Property<string>("PubId")
                        .HasMaxLength(4)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("WebAppPubs.Models.Publisher", b =>
                {
                    b.Property<string>("PubId")
                        .HasMaxLength(4)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("WebAppPubs.Models.Roysched", b =>
                {
            ...
            modelBuilder.Entity("WebAppPubs.Models.Sale", b =>
                {
                    b.Property<string>("StorId")
                        .HasMaxLength(4)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("WebAppPubs.Models.Store", b =>
                {
                    b.Property<string>("StorId")
                        .HasMaxLength(4)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("WebAppPubs.Models.Title", b =>
                {
                    b.Property<string>("TitleId")
                        .HasMaxLength(6)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("WebAppPubs.Models.Titleauthor", b =>
                {
                    b.Property<string>("AuId")
                        .HasMaxLength(11)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("WebAppPubs.Models.Titleview", b =>
                {
                    b.Property<string>("AuLname")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("WebAppPubs.Models.Discount", b =>
                {
                    b.HasOne("WebAppPubs.Models.Store", "Stor")
                        .WithMany()
            ...
            modelBuilder.Entity("WebAppPubs.Models.Employee", b =>
                {
                    b.HasOne("WebAppPubs.Models.Job", "Job")
                        .WithMany("Employees")
                        .HasForeignKey("JobId")
                        .IsRequired()
                        .HasConstraintName("FK__employee__job_id__5BE2A6F2");

                    b.HasOne("WebAppPubs.Models.Publisher", "Pub")
                        .WithMany("Employees")
                        .HasForeignKey("PubId")
                        .IsRequired()
            ...
            modelBuilder.Entity("WebAppPubs.Models.PubInfo", b =>
                {
                    b.HasOne("WebAppPubs.Models.Publisher", "Pub")
                        .WithOne("PubInfo")
                        .HasForeignKey("WebAppPubs.Models.PubInfo", "PubId")
                        .IsRequired()
            ...
            modelBuilder.Entity("WebAppPubs.Models.Roysched", b =>
                {
                    b.HasOne("WebAppPubs.Models.Title", "Title")
                        .WithMany()
            ...
            modelBuilder.Entity("WebAppPubs.Models.Titleauthor", b =>
                {
                    b.HasOne("WebAppPubs.Models.Author", "Au")
