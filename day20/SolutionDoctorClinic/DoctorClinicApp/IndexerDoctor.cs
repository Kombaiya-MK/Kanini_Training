...
namespace DoctorClinicApp
{
    internal class IndexerDoctor
    {
        ...
        public IndexerDoctor()
        {
            speciality = new string[5];
        }
        public IndexerDoctor(int S_count)
        {
            speciality = new string[S_count];
        }
        ...
        public void ShowDoctorDetails(IndexerDoctor d3)
        {
            Console.WriteLine("\nDoctor Information");
            Console.WriteLine("***********************************************");
            ...
            {
                Console.WriteLine($"{count + 1} . {speciality[count]}");
                count ++;
            }
            Console.WriteLine("***********************************************");
